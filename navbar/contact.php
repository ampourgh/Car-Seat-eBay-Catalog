  ...
  <div class="site-outer">
  	...
  	<div class="site-inner">
          ...
          <div class="container">
            ...
            <h1 class="text-center head blue">Contact Us</h1>

            <div class="footer-distributed" style="background: #fff; padding-left: 20%;">
              <div class="footer-center">

                <div>
                  <i class="fa fa-map-marker"></i>
                  <p style="color: #000;"><span>6131 Beechnut st.</span> Houston, Texas, 77074</p>
                </div>

                <div>
                  <i class="fa fa-phone"></i>
                  <p style="color: #000;">(713) 261-7380</p>
                </div>
